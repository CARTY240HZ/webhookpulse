...
export const translations: Record<string, Record<TranslationKey, string>> = {
  ...
  es: {
    ...
    'ipRules.addRule': 'AÃ±adir Regla',
    'ipRules.ip': 'DirecciÃ³n IP',
    'ipRules.action': 'AcciÃ³n',
    'ipRules.allow': 'Permitir',
    'ipRules.block': 'Bloquear',
    'ipRules.description': 'DescripciÃ³n (opcional)',
    'ipRules.delete': 'Eliminar',
    'ipRules.invalidIp': 'DirecciÃ³n IP invÃ¡lida',
    ...
    'activity.empty': 'Sin actividad aÃºn',
    ...
    'settings.phone': 'NÃºmero de telÃ©fono',
    'settings.location': 'UbicaciÃ³n',
    'settings.bio': 'BiografÃ­a',
    'settings.theme': 'Tema',
    ...
    'settings.confirmPassword': 'Confirmar contraseÃ±a',
    'settings.updateEmail': 'Actualizar email',
    'settings.updatePassword': 'Actualizar contraseÃ±a',
    'settings.passwordMin': 'MÃ­n 8 caracteres',
    'settings.deleteAccount': 'Eliminar cuenta',
    'settings.deleteWarning': 'Eliminar tu cuenta es permanente. Todos los webhooks, logs y datos serÃ¡n eliminados para siempre.',
    ...
    'settings.2fa.title': 'AutenticaciÃ³n de Dos Factores',
    'settings.2fa.description': 'AÃ±ade una capa extra de seguridad. Introduce tu telÃ©fono para recibir un cÃ³digo de verificaciÃ³n.',
    'settings.2fa.sendCode': 'Enviar cÃ³digo',
    'settings.2fa.verifyCode': 'Verificar cÃ³digo',
    'settings.2fa.codePlaceholder': 'Introduce cÃ³digo de 6 dÃ­gitos',
    ...
    'settings.2fa.success': 'TelÃ©fono verificado. 2FA ahora activo.',
    'settings.2fa.invalidCode': 'CÃ³digo invÃ¡lido. IntÃ©ntalo de nuevo.',
    'common.copy': 'Copiar',
    ...
    'login.forgot': 'Â¿Olvidaste la contraseÃ±a?',
    ...
    'landing.subtitle': 'Un receptor profesional para webhooks de Discord y genÃ©ricos. Logs en tiempo real, secretos seguros y un panel diseÃ±ado con precisiÃ³n.',
    'landing.startFree': 'Empezar gratis',
    'landing.signIn': 'Iniciar sesiÃ³n',
    'landing.goDashboard': 'Ir al Panel',
    'webhooks.templates.title': 'Plantillas Roblox',
    'webhooks.templates.playerJoin': 'Jugador Entra',
    'webhooks.templates.serverStats': 'EstadÃ­sticas',
    ...
    'search.noResults': 'NingÃºn log coincide con tus filtros',
  },
}
